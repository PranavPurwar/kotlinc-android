...
public class ImageReaderFactory {
    ...
    static {
         try {
             JAVA_HOME = Class.forName("com.sun.tools.javac.ConfigProvider").getDeclaredMethod("getJavaHome").invoke(null).toString();
        } catch (ClassNotFoundException | IllegalAccessException | NoSuchMethodException |
                 InvocationTargetException e) {
            throw new RuntimeException("Unable to determine JAVA_HOME", e);
        }
        FileSystem fs;
