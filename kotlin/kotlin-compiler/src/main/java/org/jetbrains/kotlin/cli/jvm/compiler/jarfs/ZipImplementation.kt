...
internal fun LargeDynamicMappedBuffer.contentsToByteArray(
    ...
    withMappedRangeFrom(zipEntryDescription.offsetInFile) {
        ...
        when (zipEntryDescription.compressionKind) {
            ...
            ZipEntryDescription.CompressionKind.PLAIN -> getBytes(
                startPos,
                zipEntryDescription.compressedSize.toInt()
            )
        }
    }
...
private fun LargeDynamicMappedBuffer.Mapping.getUnsignedShort(offset: Int): Int =
